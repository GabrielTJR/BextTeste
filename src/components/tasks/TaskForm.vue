  ...
  <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
    ...
    <div class="flex flex-col gap-1">
      ...
      <textarea
        ...
        rows="3"
        class="w-full px-3 py-2 text-sm bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none placeholder:text-gray-400"
      />
    </div>
